    ...
    <div className="about-page layout-center">
      ...
      <section className="about-intro">
        <div className="intro-card">
          ...
          <p className="intro-focus">
            단순 체험이 아닌, <br />
            <span>교육 이후에도 실제 활용이 가능한 수준</span>까지 연결하는 것을
            목표로 합니다.
          </p>
        </div>
      </section>
      ...
      <section className="about-section">
        ...
        <div className="category-grid">
          <div className="category-item">
            ...
            <h3>AI 도구 활용 교육</h3>
            <p>
              이미지·텍스트 생성, 영상 제작 등 실무와 일상에 바로 활용 가능한 AI
              교육
            </p>
          </div>
          <div className="category-item">
      ...
      <section className="about-section target-section">
        ...
        <ul className="target-list">
          ...
          <li>
            🏫 <strong>학교 및 청소년</strong> 교육 현장
          </li>
          <li>
            📍 <strong>지역 주민</strong> 대상 디지털 역량 강화
          </li>
          <li>
            🤝 <strong>취약계층</strong> 디지털 격차 해소 교육
          </li>
          <li>
            💰 <strong>소상공인·창업자</strong> 콘텐츠 활용 교육
          </li>
        </ul>
      </section>
