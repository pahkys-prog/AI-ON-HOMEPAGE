...
import "./QnA.css";
import { db, auth } from "../../firebase"; // firebase.ts에서 db와 auth를 모두 가져옴
import { 
  collection, 
  addDoc, 
  serverTimestamp, 
                    ...
                    {isAdmin && !q.answer && (
                      <div className="admin-controls" style={{ marginTop: '10px' }}>
                        <button 
                          ...
                          style={{ backgroundColor: '#5bb68c', color: 'white', border: 'none', padding: '5px 10px', borderRadius: '4px', cursor: 'pointer' }}
                          onClick={(e) => {
                            e.stopPropagation();
        ...
        <div className="modal-overlay">
          <div className="pwd-modal">
            ...
            <div className="modal-btns">
              ...
              <button className="confirm-btn" onClick={verifyPassword}>확인</button>
            </div>
          </div>
        </div>
      )}
