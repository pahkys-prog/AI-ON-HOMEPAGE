...
export const GALLERY_DATA: GalleryItem[] = [
  // --- GalleryArt (그림 30개 예시) ---
  {
    ...
    category: 'Art',
    title: "자청비를 만나는 시간",
    description: "처음 제주에 왔을 때는 매일 밤마다 촉촉히 비가 내리고<br> 매일 아침마다 안개가 걷히면서 맑은 날이 밝았다.<br> 하지만, 시간이 지나고... 일기도 예전과 다르다.<br> 그리고 다시 비가 내린다.<br> 모든 잎과 열매는 비로 물든다...<br>메마른 땅도 갈증을 채우고 <br> 바람도 촉촉하게 얼굴을 스친다...<br>그리고...<br>다시...<br> 하늘에 무지개 다리를 곳곳에 놓고 <br>우리의 눈이 차창을 더듬는 시간을 선물한다...<br>긴 숨결로 호흡을 늘리고 <br>느리게 흐르는 시간을 천천히 느끼는 시간은 여전하다.",
